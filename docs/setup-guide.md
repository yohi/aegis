...
> The prefix for security-related environment variables has changed from `LLM_REVIEW_SECURITY_` to `LLM_SECURITY_`.
> Please update your deployment environment variables accordingly.